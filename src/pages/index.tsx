...
const Signup: React.FC = () => {
    ...
    return (
      ...
      >
        <h3 className='text-xl font-medium text-white text-center p-2'>Join MovieMaze!</h3>
        <div>
        ...
        <div className="flex flex-col items-start gap-4 overflow-hidden rounded-md p-4 shadow-sm shadow-[#00000050] bg-gray-800">
    ...
    <div className="relative flex h-[50px] w-[50px] items-center justify-center">
      <input
        type="radio"
        id="radio" onChange={handleChangeInput}
        name="gender"
        value="male"
    ...
    <div className="relative flex h-[50px] w-[50px] items-center justify-center">
      <input
        type="radio" onChange={handleChangeInput}id="radio"name="gender"value="female" className="peer z-10 h-full w-full cursor-pointer opacity-0"
      />
      <div
    ...
    <div className="relative flex h-[50px] w-[50px] items-center justify-center">
      <input type="radio" name="gender" onChange={handleChangeInput} value="none-binary"className="peer z-10 h-full w-full cursor-pointer opacity-0"/>
      <div
